    ...
    <div className="flex w-full items-center justify-between gap-3 rounded-xl border border-gray-800 bg-gray-900/70 px-3 py-2 sm:w-auto sm:justify-start sm:rounded-none sm:border-0 sm:bg-transparent sm:p-0">
      {date > minDate && (
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-gray-800 bg-gray-950 text-lg text-gray-300 transition-colors hover:text-white sm:h-auto sm:w-auto sm:border-0 sm:bg-transparent sm:text-xl"
        >
          ‹
        </button>
      )}
